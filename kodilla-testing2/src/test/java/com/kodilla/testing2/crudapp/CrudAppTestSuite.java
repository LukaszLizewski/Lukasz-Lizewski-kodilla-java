...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://LukaszLizewski.github.io";
    ...
    public String createCrudAppTestTask ()  throws InterruptedException {
        ...
        final String XPATH_ADD_BUTTON ="//form[contains(@action, \"createTask\")]//button[1]";
    ...
    private boolean checkTaskExistInTrello (String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("lizewski.lukasz@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("myszy320");
        ...
        result = driverTrello.findElements(By.xpath("//span")).stream()
                .anyMatch(thrSpan -> thrSpan.getText().equals(taskName));
