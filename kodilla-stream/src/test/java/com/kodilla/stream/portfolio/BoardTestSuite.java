...
public class BoardTestSuite {
    ...
    @Test
    public void testAddTaskListAverageWorkingOnTaskDoubleStream() {
        //Given
        Board project = prepareTestData();
        //When
        ...
        double sumOfTasks = project.getTaskLists().stream()
                ...
                .mapToDouble(tl -> tl.getTasks().size())
                .sum();
        ...
        //Then
        Assert.assertEquals(3,sumOfTasks,0.1);
        Assert.assertEquals(30,sumOfDays,0.1);
        Assert.assertEquals(10,average,0.1);
    }
    @Test
    public void testAddTaskListAverageWorkingOnTaskAllInOneStream() {
        //Given
        Board project = prepareTestData();
        //When
        List<TaskList> inProgressTask = new ArrayList<>();
